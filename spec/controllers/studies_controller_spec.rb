...
RSpec.describe StudiesController, type: :controller do
  ...
  describe 'GET #show' do
    it 'assigns the requested study as @study' do
      study = Study.create! valid_attributes
      get :show, params: { id: study.to_param }, session: valid_session
  ...
  describe 'POST #create' do
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved study as @study' do
        post :create, params: { study: invalid_attributes }, session: valid_session
        expect(assigns(:study)).to be_a_new(Study)
      end
  ...
  describe 'PUT #update' do
    ...
    context 'with invalid params' do
      it 'assigns the study as @study' do
        study = Study.create! valid_attributes
        put :update, params: { id: study.to_param, study: invalid_attributes }, session: valid_session
        expect(assigns(:study)).to eq(study)
      end
